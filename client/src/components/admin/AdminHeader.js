    ...
    <CHeader position="sticky" className="mb-4 header"  >
        <CContainer fluid  >
          <CHeaderNav className="d-none d-md-flex me-auto"  >
            <CNavItem>
              <CNavLink to="/admin" component={NavLink} className='d-flex'>
                <CImage src={salogo} height={48} />
                <CNavItem className="header-brand">&nbsp; Admin Dashboard</CNavItem>
              </CNavLink>
            </CNavItem>
          </CHeaderNav>
            ...
            <CDropdown variant="nav-item">
                <CForm className="d-flex">
                    ...
                    {/* <CDropdownToggle placement="bottom-end" className="py-0" caret={false}>
                        <Link to='/adminprofile'><CAvatar src={avatar} size="lg" /></Link>
                    </CDropdownToggle> */}
                    <CDropdown variant="nav-item">
                      <CDropdownToggle placement="bottom-end" className="py-0" caret={false}>
